...
function setupRequestLogging(app: express.Application) {
  app.use((req, res, next) => {
    ...
    res.on("finish", () => {
      if (!reqPath.startsWith("/api") && !reqPath.startsWith("/pay")) return;
...
async function setupViteDevServer(app: express.Application) {
...
function serveProductionBuild(app: express.Application) {
  ...
  if (fs.existsSync(distPath)) {
    ...
    log("Warning: dist/public not found. Run 'npx vite build' first.");
  }
}
